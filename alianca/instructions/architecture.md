...
keywords: arquitetura, arquitetural, estrutura do projeto, estrutura de pastas, reestruturar, modulo, modulos, camada, camadas, fronteira, dependencia, dependencias, servico, servicos, boundary, decisao
load-when: execução
